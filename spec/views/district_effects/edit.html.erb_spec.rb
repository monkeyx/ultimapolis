...
RSpec.describe "district_effects/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit district_effect form" do
    render

    assert_select "form[action=?][method=?]", district_effect_path(@district_effect), "post" do
