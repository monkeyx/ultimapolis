...
writing = Skill.create_new!("Writing", "Art", "Composing inspired or interesting prose", creative, blogger, professor)
broker = Skill.create_new!("Broker", "Business", "Negotiating trade deals", management, fixer, retailer)
carouse = Skill.create_new!("Carouse", "Social", "Socialising and having fun", creative, celeb, politico)
comms = Skill.create_new!("Comms", "Tech", "Telecommunications and signals processing", spook, politico, blogger)
...
driving = Skill.create_new!("Driving", "Tech", "Controlling ground vehicles of all kinds", engineer, labourer, suit)
engineering = Skill.create_new!("Engineering", "Tech", "Operating machinery and specialised equipment", labourer, engineer, hacker)
demolitions = Skill.create_new!("Demolitions", "Tech", "Use of demolition charges and explosives", engineer, gangster, labourer)
flying = Skill.create_new!("Flying", "Tech", "Controlling flyers of all kinds", engineer, pilot, suit)
gambling = Skill.create_new!("Gambling", "Social", "Familiarity with a variety of gambling games", creative, politico, gangster)
...
languages = Skill.create_new!("Languages", "Intelligence", "Linguistics and translation", blogger, politico, professor)
...
medic = Skill.create_new!("Medic", "Science", "First aid, medical diagnosis, treatment and surgery", engineer, professor, doctor)
persuasion = Skill.create_new!("Persuasion", "Social", "Fast talking, bargaining and bluffing", spook, creative, fixer)
...
electronics = Skill.create_new!("Electronics", "Science", "Study of circuits and computer hardware", professor, engineer, hacker)
biology = Skill.create_new!("Biology", "Science", "Study of living organisms", professor, doctor, nil)
economics = Skill.create_new!("Economics", "Science", "Study of trade and markets", professor, management, politico)
psychology = Skill.create_new!("Psychology", "Science", "Study of thought and society", professor, doctor, civic)
steward = Skill.create_new!("Steward", "Business", "Caring and service for other citizens", politico, retailer, fixer)
tactics = Skill.create_new!("Tactics", "Military", "Planning and decision making", home_guard, pilot, nil)
craft = Skill.create_new!("Craft", "Business", "Producing useful goods or services", labourer, creative, engineer)
