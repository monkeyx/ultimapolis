...
Blogit.configure do |config|
  ...
  config.rss_feed_title = "Ultimapolis News"

  # RSS Feed description content
  config.rss_feed_description = "Latest from Ultimapolis"
